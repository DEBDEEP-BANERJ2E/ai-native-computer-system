#!/usr/bin/env python3
"""
Differential Verification Test: Checks all 5 benchmark programs and full ISA matrix in the Python reference interpreter.
"""
...
def test_program2():
    ...
    print(f"  -> Program 2 Passed! [x1=0, x2=15, final PC=0x18, total steps={len(trace)}]")
...
if __name__ == "__main__":
    ...
    test_program4()
    test_program5()
    print("\nALL REFERENCE EMULATOR BENCHMARKS PASSED 100%!")
